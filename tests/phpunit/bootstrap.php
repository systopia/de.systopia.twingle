...
// Make CRM_Twingle_ExtensionUtil available.
require_once __DIR__ . '/../../twingle.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('de.systopia.twingle');
 ...
 */
function _twingle_test_civicrm_container(ContainerBuilder $container): void {
}
