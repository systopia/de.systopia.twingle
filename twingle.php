 ...
 */
function twingle_civicrm_xmlMenu(&$files) {
  _twingle_civix_civicrm_xmlMenu($files);
}
 ...
 */
function twingle_civicrm_managed(&$entities) {
  _twingle_civix_civicrm_managed($entities);
}
 ...
 */
function twingle_civicrm_caseTypes(&$caseTypes) {
  _twingle_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function twingle_civicrm_angularModules(&$angularModules) {
  _twingle_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function twingle_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
 ...
 *
function twingle_civicrm_preProcess($formName, &$form) {
